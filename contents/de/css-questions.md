...
Antworten auf [Front-end Job Interview Questions - CSS Questions](https://github.com/h5bp/Front-end-Developer-Interview-Questions/blob/master/src/questions/css-questions.md). Pull-Requests für Vorschläge und Korrekturen sind willkommen!

## Table of Contents

- [Was ist mit "CSS Selector Spezifität" gemeint und wie funktioniert sie?](#was-ist-mit-CSS-Selector-Spezifität-gemeint-und-wie-funktioniert-sie)
- [Was unterscheidet "resetting" von "normalizing"? Was wählst du und warum?](#was-unterscheidet-resetting-von-normalizing-was-wählst-du-und-warum?)
- [Was sind `float`s und wie funktionieren sie?](#was-sind-floats-und-wie-funktionieren-sie)
- [Was ist der z-index und wie wird der Stapelkontext gebildet.](#was-ist-der-z-index-und-wie-wird-der-stapelkontext-gebildet)
- [Erkläre BFC (Block Formatting Context) und wie er funktioniert.](#erkläre-block-formatting-context-bfc-und-wie-er-funktioniert)
- [Welche Clearing Techniken kennst du und in welchen Kontexten werden sie eingesetzt?](#welche-clearing-techniken-kennst-du-und-in-welchen-kontexten-werden-sie-eingesetzt)
- [Erkläre CSS sprites und wie du sie auf deiner Seite einbindest](#erkläre-css-sprites-und-wie-du-sie-auf-deiner-seite-einbindest)
- [Wie gehst du vor, um browserspezifische Styling-Probleme zu beheben?](#wie-gehst-du-vor-um-browserspezifische-styling-probleme-zu-beheben)
- [Wie stellst du Seiten für funktionsbeschränkte Browser bereit? Welche Techniken/Prozesse verwendest du?](#wie-stellst-du-seiten-für-funktionsbeschränkte-browser-bereit-welche-techniken/prozesse-verwendest-du)
- [Welche Möglichkeiten gibt es, Inhalte visuell auszublenden (und nur für Screenreader verfügbar zu machen)?](#welche-möglichkeiten-gibt-es-inhalte-visuell-auszublenden-und-nur-für-screenreader-verfügbar-zu-machen)
- [Hast du jemals ein Grid-System verwendet und wenn ja: Welches bevorzugst du?](#hast-du-jemals-ein-grid-System-verwendet-und-wenn-ja-welches-bevorzugst-du)
- [Hast du jemals Media Queries genutzt oder Layouts/CSS für mobile Anwendungen entwickelt?](#hast-du-jemals-media-queries-genutzt-oder-layouts/css-für-mobile-anwendungen-entwickelt)
- [Bist du mit SVG vertraut?](#bist-du-mit-svg-vertraut)
- [Kennst du außer Screen noch weitere @media Properties?](#kennst-du-außer-screen-noch-weitere-@media-properties)
- [Nenne einige "Fallstricke" beim Schreiben von CSS?](#nenne-einige-fallstricke-beim-schreiben-von-css)
- [Was sind die Vorteile/Nachteile der Verwendung von CSS-Präprozessoren?](#was-sind-die-vorteilenachteile-der-verwendung-von-css-präprozessoren)
- [Beschreibe, welche CSS-Präprozessoren du verwendet hast und was du an ihnen magst und was du nicht magst.](#beschreibe-welche-css-präprozessoren-du-verwendet-hast-und-was-du-an-ihnen-magst-und-was-du-nicht-magst)
- [Wie lieferst du ein Webdesign aus, das Nicht-Standard-Schriften verwendet?](#wie-lieferst-du-ein-webdesign-aus-das-nicht-standard-schriften-verwendet)
